...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--json_file",
        default="/root/data/os_atlas/desktop_domain/linux_splited.json",
        help="Path to the JSON file containing OS Atlas data",
    )
    parser.add_argument(
        "--image_dir", default="/root/data/os_atlas/desktop_domain/linux_images/", help="Path to the directory containing images"
    )
    parser.add_argument(
        "--local_dir",
        default="~/data/os_atlas_converted",
    ...
    parser.add_argument(
        "--prompt_format",
        choices=["qwen", "thinking", "sft", "subtask"],
        default="subtask",
        help="Select prompt format: 'qwen' or 'thinking' or 'sft' or 'subtask'",
    )
    parser.add_argument(
        "--chunk_size",
        type=int,
